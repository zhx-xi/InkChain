...
export default defineConfig({
  ...
  webServer: [
    {
      command: "INKCHAIN_STUDIO_PORT=4581 INKCHAIN_AGENT_LLM_STUB=1 INKCHAIN_PROJECT_ROOT=\"${INKCHAIN_E2E_PROJECT_ROOT:-test-project}\" tsx watch --clear-screen=false src/api/index.ts",
