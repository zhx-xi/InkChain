...
export function TimelinePage({ bookId }: TimelinePageProps) {
  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto px-6 py-12 md:px-12 lg:py-16 fade-in" data-testid="tl-state-loading">
  ...
  if (events.length === 0) {
    return (
      <><div className="max-w-4xl mx-auto px-6 py-12 md:px-12 lg:py-16 fade-in" data-testid="tl-state-empty">
