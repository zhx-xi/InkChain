// ── AI Foreshadowing Extraction Route (Issue #211 — AI自动导入提取) ──
//
// Routes (mounted at /api/v1/books):
//   POST /:id/chapters/:chapterNum/extract/foreshadowing — Extract foreshadowings from chapter text
...
export function createForeshadowingExtractRouter(
