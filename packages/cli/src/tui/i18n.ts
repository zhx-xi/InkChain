...
const ZH_CN: TuiCopy = {
  ...
  composer: {
    placeholder: "告诉 InkChain 要写什么、修改什么，或解释什么…",
    emptyConversation: "先告诉 InkChain 你要做什么。",
  ...
  notes: {
    ...
    config: "当前 Ink 仪表盘里还不支持交互式 /config。请使用 inkchain config set-global。",
...
const EN: TuiCopy = {
  ...
  composer: {
    placeholder: "Ask InkChain to write, revise, or explain…",
    emptyConversation: "Start by asking InkChain what to do.",
  ...
  notes: {
    ...
    config: "Interactive /config is not available inside the Ink dashboard yet. Use inkchain config set-global.",
