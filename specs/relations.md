...
| GET | `/:id/relations` | CharacterRelationSchema, RelationsFileSchema | CharacterRelationSchema, RelationsFileSchema | — |
| POST | `/:id/relations` | CharacterRelationSchema, RelationsFileSchema | CharacterRelationSchema, RelationsFileSchema | — |
| PUT | `/:id/relations/:relationId` | CharacterRelationSchema, RelationsFileSchema | CharacterRelationSchema, RelationsFileSchema | — |
| DELETE | `/:id/relations/:relationId` | CharacterRelationSchema, RelationsFileSchema | CharacterRelationSchema, RelationsFileSchema | — |
|------|------|-------------|-------------|------|
...
| `CharacterRelationSchema` | object | {
  id: z.string( |
| `RelationsFileSchema` | object | {
  schemaVersion: z.literal("1" |
| `RelationType` | enum | close_friend, // 挚友
  "rival, // 敌对
  "alliance, // 联盟
  "mentor, // 师徒
  "blood |
