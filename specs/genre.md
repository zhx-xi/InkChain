...
| GET | `/presets` | GenreProfileSchema | GenreProfileSchema | — |
| GET | `/presets/:id` | GenreProfileSchema | GenreProfileSchema | — |
| POST | `/presets/:id/apply` | GenreProfileSchema | GenreProfileSchema | — |
| POST | `/presets` | GenreProfileSchema | GenreProfileSchema | — |
| DELETE | `/presets/:id` | GenreProfileSchema | GenreProfileSchema | — |
|------|------|-------------|-------------|------|
