...
| GET | `/:id/scene-roles` | SceneRoleSchema, SceneRolesFileSchema | SceneRoleSchema, SceneRolesFileSchema | — |
| POST | `/:id/scene-roles` | SceneRoleSchema, SceneRolesFileSchema | SceneRoleSchema, SceneRolesFileSchema | — |
| PUT | `/:id/scene-roles/:name` | SceneRoleSchema, SceneRolesFileSchema | SceneRoleSchema, SceneRolesFileSchema | — |
| DELETE | `/:id/scene-roles/:name` | SceneRoleSchema, SceneRolesFileSchema | SceneRoleSchema, SceneRolesFileSchema | — |
|------|------|-------------|-------------|------|
