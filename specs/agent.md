...
| GET | `/` | AgentRoleConfigSchema, AgentTeamConfigSchema | AgentRoleConfigSchema, AgentTeamConfigSchema | — |
| PUT | `/` | AgentRoleConfigSchema, AgentTeamConfigSchema | AgentRoleConfigSchema, AgentTeamConfigSchema | — |
|------|------|-------------|-------------|------|
...
| Schema | 类型 | 定义 |
|--------|------|------|
| `AgentRoleConfigSchema` | object | {
  role: z.string( |
| `AgentTeamConfigSchema` | object | {
